...
public class FileSearcher {
	...
	public TopDocs searchByLabel(String label, int resultAmount) throws IOException, ParseException {
		QueryParser qp = new QueryParser(DocumentField.LABEL_FIELD, new StandardAnalyzer());
		Query idQuery = qp.parse(label);
		qp.setDefaultOperator(QueryParser.Operator.AND);
